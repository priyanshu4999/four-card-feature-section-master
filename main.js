    ...
    <article class="container">
        ...
        <section class="card-grid">
            <div class="card card--cyan">
                ...
                <figure><img src="${data.cards.supervisor.img}"/></figure>
            </div>
            ...
            <div class="card card--blue">
                ...
                <figure><img src="${data.cards.calculator.img}"/></figure>
            </div>
